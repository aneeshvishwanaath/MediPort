  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        ...
        <Button asChild>
          <Link href="/dashboard/add-pharmacy">
            <PlusCircle className="mr-2 h-4 w-4" /> Add/Edit Pharmacy Details
          </Link>
        </Button>
      </div>
      <Card>
        <CardHeader>
          <CardTitle>Patient Prescription Search</CardTitle>
          <CardDescription>
                  ...
                  <TableRow key={patient.id}>
                    ...
                    <TableCell className="text-right">
                       <Button
                        variant="outline"
                        size="sm"
                        onClick={() => router.push(`/dashboard/patient/${patient.id}?view=prescriptions`)}
                      >
                        View Prescriptions
                      </Button>
                    </TableCell>
